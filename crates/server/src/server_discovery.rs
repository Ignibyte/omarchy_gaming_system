...
pub(crate) async fn document(
    ...
    Ok(document_for(server_id, server_name, provider_enabled))
}

fn document_for(server_id: Uuid, server_name: &str, provider_enabled: bool) -> DiscoveryDocument {
...
mod tests {
    ...
    fn provider_capability_is_truthful_and_ordered() {
        ...
        let base = document_for(server_id, "Test Community", false);
        let provider = document_for(server_id, "Test Community", true);
